...
class OrderDetailsCell: BaseTVCell {
    ...
    let fromImageView: UIImageView = {
        let iv = UIImageView()
        iv.contentMode = .scaleAspectFill
        iv.image = #imageLiteral(resourceName: "from")
        return iv
    }()
    ...
    let toImageView: UIImageView = {
        let iv = UIImageView()
        iv.contentMode = .scaleAspectFill
        iv.image = #imageLiteral(resourceName: "to")
    ...
    override func setupViews() {
        ...
        contentView.addSubview(toImageView)
        toImageView.anchor(top: fromImageView.bottomAnchor, left: descriptionImageView.leftAnchor, bottom: nil, right: nil, paddingTop: 13, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 21, height: 21)
        
        
        contentView.addSubview(toLabel)
        toLabel.anchor(top: nil, left: toImageView.rightAnchor, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 11, paddingBottom: 0, paddingRight: 40, width: 0, height: 14)
        
        toLabel.centerYAnchor.constraint(equalTo: toImageView.centerYAnchor).isActive = true
